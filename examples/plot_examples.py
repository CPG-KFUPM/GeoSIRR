...
PLOT_OPTIONS = {
    ...
    "example_listric_normal_fault_2_refined_2.txt": {
        "title": "Refined listric normal fault 2"
    },
    "example_prograding_delta.txt": {"title": "Prograding delta"},
    "example_syn-rift_half-graben.txt": {"title": "Syn-rift half-graben", "legend_padding": 0.25, "font_size": 6, "vertex_font_size": 5, "line_width": 0.7, "vertex_size": 2, "figsize": (12, 7)},
}
